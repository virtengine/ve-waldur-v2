...
class OpenNebulaTemplatesViewSet(viewsets.ViewSet):
    ...
    def retrieve(self, request, pk=None):  # TODO: Implentation
        ...
        try:
            ...
            # TODO: fetch template details when OpenNebula client implementation is available
            template = ""
            if not template:
                return Response(
...
class OpenNebulaImagesViewSet(viewsets.ViewSet):
    ...
    def retrieve(self, request, pk=None):  # TODO: Implentation
        ...
        try:
            ServiceSettings.objects.get(pk=service_settings_id)
            # TODO: fetch image details when OpenNebula client implementation is available
            image = ""
            if not image:
                return Response(
